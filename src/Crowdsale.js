...
class Crowdsale extends Component {
  ...
  async getBalanceInvestor() {
    const { crowdsaleContract, account } = this.state;
    
    const instance = await crowdsaleContract.deployed();
    await instance.getBalanceInvestor({gas: 4412200, from: account }).then(result => {
      this.setState({investorsETH: result.toString()})
    })
  }
  ...
  async setPrivlegedWallet() {
    ...
    await instance.setPrivlegedWallet(addressPrivilegedWallet, {gas: 4412200, from: account }).then(result => {
  ...
  async removePrivlegedWallet() {
    ...
    await instance.removePrivlegedWallet(addressPrivilegedWallet, {gas: 4412200, from: account }).then(result => {
              ...
              <Col md={{ size: '5'}}>
                ...
                <Table striped bordered>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Price for Current Investor (1 GMC)</td>
                      <td>{this.state.priceCurrentInvestor} WEI</td>
                    </tr>
                    <tr>
                      <td>Price for minimum amount (0.01 GMC)</td>
                      <td>1000000000000 WEI</td>
                    </tr>
                  </tbody>
                </Table>
                <br></br> 
                  ...
                  <Card style={{ backgroundColor: 'whitesmoke' }}>
                    <CardBlock>
                      ...
                      <Input 
                        ...
                        placeholder="Enter Amount of WEI"
                  ...
                  <div>
                    <Card style={{ backgroundColor: 'whitesmoke' }}>
                      <CardBlock>
                        ...
                        <br></br>              
                        <h5>Enter Address to privlege Wallet</h5>                                  
                        <Input 
                          value={this.state.addressPrivilegedWallet}
                          placeholder="Enter Address to privlege Wallet"
